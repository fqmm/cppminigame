...
{
    cout<<"欢迎来到彩票游戏！"<<endl<<endl<<"温馨提示：在游戏内请勿使用小数、负数、英文字母、特殊字符（游戏中另说明除外），"<<endl<<"否则后果自负。"<<"到后期可能会出现卡顿，纯属正常现象。"<<endl<<endl;
    ...
    if (d==1)
    {
        ...
        cout<<"你有100美元，当你赚了超过1,000,000,000美元，你就发财了。"<<endl<<"但如果你失去了所有的钱，你破产了。"<<endl;
    ...
    if (d==4)
    {
        ...
        cout<<"你有100美元，当你赚了超过10,000,000,000美元，你就发财了。"<<endl<<"但如果你失去了所有的钱，你破产了。"<<endl;
    ...
    if (d==5)
    {
        ...
        cout<<"你有100美元，当你赚了超过10,000,000,000美元，你就发财了。"<<endl<<"但如果你失去了所有的钱，你就破产了。"<<endl;
